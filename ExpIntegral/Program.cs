    ...
    internal class Program {
        static void Main(string[] args) {
            ...
            static (MultiPrecision<Pow2.N16> f, MultiPrecision<Pow2.N16> g) invg16(MultiPrecision<Pow2.N16> x) {
                ...
                (MultiPrecision<Pow2.N16> f, MultiPrecision<Pow2.N16> g) = SinCosIntegralN16.FG(v);
             ...
             static (MultiPrecision<Pow2.N32> f, MultiPrecision<Pow2.N32> g) invg32(MultiPrecision<Pow2.N32> x) {
                ...
                (MultiPrecision<Pow2.N32> f, MultiPrecision<Pow2.N32> g) = SinCosIntegralN32.FG(v);
            ...
            using (StreamWriter sw = new("../../../../results/cisi_log2log2_fg.csv")) {
                sw.WriteLine("x,f,g");

                for (double x = 0; x <= 8; x += 1d / 64) {
