...
namespace ExpIntegral {
    internal class Program {
        static void Main() {
            ...
            //using (StreamWriter sw = new("../../../../results_disused/cisi_scaled_fg_mp32_8.csv")) {
            //    sw.WriteLine("x,f,g");

            //    for (double x = 0.5; x <= 256; x += 1d / 16) {
            //        (MultiPrecision<Pow2.N32> f, MultiPrecision<Pow2.N32> g) = invg32(x);

            //        sw.WriteLine($"{x},{f},{g}");
            //        Console.WriteLine($"{x},{f:e10},{g:e10}");
            //    }
            //}
            ...
            using StreamWriter f_sw = new("../../../../results_disused/cisi_scaled_f_pade_table_256.csv");
            using StreamWriter g_sw = new("../../../../results_disused/cisi_scaled_g_pade_table_256.csv");
